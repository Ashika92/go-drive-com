...
import { products } from "../data/cars"; // <- import shared data

const CarList = () => {
  const [filters, setFilters] = useState({ name: "", model: "", priceRange: null });
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <h2 className="text-3xl font-bold text-center mb-6">EXPLORE OUR CARS</h2>
      ...
      {filteredProducts.length === 0 && (
        <p className="text-center text-gray-500 mt-6">No cars match your filters.</p>
      )}
    </div>
  );
};
